...
export default function Terms() {
  return (
    <>
      <Helmet><title>Terms of Service - SmugFlex</title></Helmet>
      ...
      <section className="content-section" style={{ padding: '60px 0 120px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px', color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: '0.95rem' }}>
          ...
          <p>All donations are final and non-refundable unless otherwise required by law. SmugFlex reserves the right to decline any donation.</p>
          <h2 style={{ color: 'white', fontFamily: 'var(--font-display)', fontSize: '1.3rem', margin: '32px 0 12px' }}>4. Intellectual Property</h2>
          <p>All content on this website, including text, graphics, logos, and images, is the property of SmugFlex and is protected by copyright laws.</p>
          <h2 style={{ color: 'white', fontFamily: 'var(--font-display)', fontSize: '1.3rem', margin: '32px 0 12px' }}>5. Limitation of Liability</h2>
          <p>SmugFlex shall not be liable for any indirect, incidental, or consequential damages arising from your use of the website.</p>
