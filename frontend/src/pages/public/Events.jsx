...
const events = [
  { title: 'Global Education Summit 2026', date: '2026-09-15', location: 'New York, USA', image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600', category: 'Conference', desc: 'Join leaders from 50+ countries to discuss the future of global education.' },
  ...
  { title: 'Annual Fundraising Gala', date: '2026-10-05', location: 'London, UK', image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=600', category: 'Gala', desc: 'An evening of inspiration, impact stories, and fundraising.' },
  { title: 'Clean Water Hackathon', date: '2026-11-12', location: 'Berlin, Germany', image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=600', category: 'Hackathon', desc: 'Tech solutions for water scarcity challenges.' },
  { title: 'Volunteer Appreciation Day', date: '2026-12-01', location: 'Global (Virtual)', image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600', category: 'Celebration', desc: 'Celebrating our incredible volunteers worldwide.' },
  { title: 'Youth Leadership Camp', date: '2027-01-15', location: 'Costa Rica', image: 'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?w=600', category: 'Camp', desc: 'Empowering the next generation of community leaders.' },
]
...
export default function Events() {
  return (
    <>
      <Helmet><title>Events - SmugFlex</title><meta name="description" content="Join SmugFlex events — conferences, workshops, galas, and community gatherings." /></Helmet>
      <AuroraBackground intensity="light">
        <div style={{ minHeight: '50vh', display: 'flex', alignItems: 'center', padding: '120px 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.15rem', lineHeight: 1.7 }}>Conferences, workshops, galas, and community gatherings — connect with us in person and online.</p>
          </div>
        </div>
      </AuroraBackground>
              ...
              <ScrollReveal key={e.title} delay={i * 0.1}>
                <GlassCard style={{ overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '24px' }}>
                    ...
                    <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem', marginBottom: '8px' }}>{e.title}</h3>
