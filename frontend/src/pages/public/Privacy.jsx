...
export default function Privacy() {
  return (
    <>
      <Helmet><title>Privacy Policy - SmugFlex</title></Helmet>
      ...
      <section style={{ padding: '60px 0 120px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px', color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: '0.95rem' }}>
          ...
          <p>You have the right to access, correct, or delete your personal data. Contact us at privacy@smugflex.org to exercise these rights.</p>
          <h2 style={{ color: 'white', fontFamily: 'var(--font-display)', fontSize: '1.3rem', margin: '32px 0 12px' }}>6. Contact</h2>
          <p>For privacy-related inquiries, contact us at privacy@smugflex.org or write to: SmugFlex Privacy Team, 123 Impact Avenue, New York, NY 10001.</p>
